...
@5: (GambitCharges<<5)|(RallyMag<<4)||MagDebuff
@Huichelaar edit: now leaving top 3 MSBits unaffected.
ldrb  r0, [r3, #0x5]
mov   r2, r0
mov   r1, #0xE0
and   r2, r1                @ GambitCharges << 5.
mov   r1, #0xF
and   r2, r1                @ Clear rally mag flag (and GambitCharges).
cmp   r2, #0x0
beq   NoMagDebuff
	sub   r0, #0x1
NoMagDebuff:
orr   r0, r2                @ Put GambitCharges back.
strb  r0, [r3, #0x5]
