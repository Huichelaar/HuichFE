...
@   +0x64: byte, timer. Used to determine which shine cell to display. Not initialized here.
@   +0x66: short, Gem spiral timer, once zero, break spiral loop. Initialized to 0x14.
.thumb
...
mov   r1, #0x66
mov   r2, #0x14
strh  r2, [r5, r1]                        @ Gem spiral timer, once zero, break spiral loop
mov   r1, #0x2B
mov   r2, #0x3
