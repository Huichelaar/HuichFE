...
@   +0x2B: byte, Gemsprite's Attribute 0, Mos+OM+GM. Set to 0x0, regular.
...
@   +0x64: byte, timer. Used to determine which shine cell to display. Initialized in Init_Line.
@   +0x66: short, Gem timer, once zero, break loop. Initialized to 0x10B.
.thumb
