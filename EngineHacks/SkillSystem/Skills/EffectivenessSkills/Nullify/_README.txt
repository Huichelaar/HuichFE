Huichelaar EDIT: This is no longer a config option. Slayer and effectiveness rework is always active. The next paragraph is now inaccurate, but kept to preserve the original README.
