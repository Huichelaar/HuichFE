...
parser.add_argument('-r', default=8, type=int, help='Red value modifier, [0, 31]. Default is 8')
parser.add_argument('-g', default=-8, type=int, help='Green value modifier, [0, 31]. Default is -8')
parser.add_argument('-b', default=-8, type=int, help='Blue value modifier, [0, 31]. Default is -8')
