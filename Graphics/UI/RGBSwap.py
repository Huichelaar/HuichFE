...
parser.add_argument('-i', default="RangeSquaresRedPalette.dmp", help='Input palette file.')
parser.add_argument('-o', default="RangeSquaresPurplePalette.dmp", help='Output palette file.')
